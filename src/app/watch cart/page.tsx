        ...
        <div className="font-sans mt-16">
            <div className="grid items-start grid-cols-1 lg:grid-cols-3">
                ...
                <div className="py-6 px-8 max-lg:max-w-2xl">
                    <div>
                        <h2 className="text-2xl font-extrabold text-gray-800">Adjective Attire | Watches</h2>
                        <p className="text-sm text-gray-400 mt-2">AF Ahmed Fashion</p>
                    </div>
                    ...
                    <div className="flex space-x-1 mt-4">
                        ...
                        <div className="mt-8">
                        <p className="text-gray-800 text-4xl font-bold">Rs.1999</p>
                        <p className="text-gray-400 text-sm mt-2">
                            <span>Rs.2999</span> <span className="text-sm ml-0">Tax included</span>
                        </p>
                    </div>
                    ...
                    <div className="mt-8">
                        ...
                        <div className="mt-4 flex flex-wrap gap-2">
                            {sizes.map((size) => (
                                <button
                                    key={size}
                                    className={`px-4 py-2 border rounded-md ${activeSize === size
    ...
    Buy Now
                    ...
                    <div className="mt-8">
                        <div>
                            ...
                            <p className="text-sm text-gray-800 mt-4">Elevate your casual style with our premium mens t-shirt. Crafted for comfort and designed with a modern fit this versatile shirt is an essential addition to your wardrobe. The soft and breathable fabric ensures all-day comfort making it perfect for everyday wear. Its classNameic crew neck and short sleeves offer a timeless look.</p>
                        </div>
