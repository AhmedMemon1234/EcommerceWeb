...
const products = [
  { id: 1, name: 'Mobile', image: '/watch3.png', price: '$12' },
...
export default function Cartsec2() {
  ...
  const [selectedImage, setSelectedImage] = useState<string>('/watch3.png');
        ...
        <div className="grid items-start grid-cols-1 md:grid-cols-2 gap-6">
          <div className="w-full lg:sticky top-0 flex gap-3 z-10">
            ...
            <div className="w-20 flex flex-col gap-3">
              {["/watch3.png", "/watch3.png", "/watch3.png", "/watch3.png"].map((img) => (
                <Image
                  key={img}
                  src={img}
                  alt="Thumbnail"
