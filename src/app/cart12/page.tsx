...
const products = [
  { id: 1, name: 'Mobile', image: '/oneplus9.jpg', price: '$12' },
...
export default function Cartsec2() {
  ...
  const [selectedImage, setSelectedImage] = useState<string>('/oneplus9.jpg');
        ...
        <div className="grid items-start grid-cols-1 md:grid-cols-2 gap-6">
          <div className="w-full lg:sticky top-0 flex gap-3 z-10">
            ...
            <div className="w-20 flex flex-col gap-3">
              {["/oneplus9.jpg", "/oneplus9.jpg", "/oneplus9.jpg", "/oneplus9.jpg"].map((img) => (
                <Image
                  key={img}
                  src={img}
                  alt="Thumbnail"
          ...
          <div className="lg:pl-8">
            <h2 className="text-2xl font-bold text-gray-800">Oneplus 9 | USA Stock </h2>
            ...
            <div className="mt-10 flex gap-4">
              <button
                type="button"
                onClick={() => handleAddToCart({ id: 1, name: 'Oneplus 9 Original | USA Stock', price: "$1200", image: selectedImage })}
