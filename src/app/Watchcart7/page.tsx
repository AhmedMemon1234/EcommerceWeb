...
const products = [
  { id: 1, name: 'Mobile', image: '/watchpic10.jpg', price: '$12' },
  ...
  { id: 7, name: 'Women 1', image: '/women2.jpg', price: '$30' },
  { id: 8, name: 'Women 2', image: '/women3.jpg', price: '$28' },
  ...
  { id: 12, name: 'Watch 3', image: '/watchpic10.jpg', price: '$50' },
];

export default function Cartsec2() {
  const [selectedSize, setSelectedSize] = useState<string>('');
  const [selectedColor, setSelectedColor] = useState<string>('');
  const [selectedImage, setSelectedImage] = useState<string>('/watchpic10.jpg');
        ...
        <div className="grid items-start grid-cols-1 md:grid-cols-2 gap-6">
          <div className="w-full lg:sticky top-0 flex gap-3 z-10">
            ...
            <div className="w-20 flex flex-col gap-3">
              {["/watchpic10.jpg", "/watchpic10.jpg", "/watchpic10.jpg", "/watchpic10.jpg"].map((img) => (
                <Image
                  key={img}
                  src={img}
                  alt="Thumbnail"
          ...
          <div className="lg:pl-8">
            <h2 className="text-2xl font-bold text-gray-800">Smart Watch For man Original | USA Stock </h2>
            ...
            <div className="mt-10 flex gap-4">
              <button
                type="button"
                onClick={() => handleAddToCart({ id: 1, name: 'Smart Watch For Man Original | USA Stock ', price: "$1200", image: selectedImage })}
