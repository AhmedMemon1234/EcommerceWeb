...
const products = [
  ...
  { id: 10, name: 'Shirt 1', image: '/shirt1.jpg', price: '$40' },
  { id: 11, name: 'Shirt 2', image: '/shirt1.jpg', price: '$42' },
  { id: 12, name: 'Shirt 3', image: '/shirt1.jpg', price: '$50' },
];

export default function Cartsec2() {
  const [selectedSize, setSelectedSize] = useState<string>('');
  const [selectedColor, setSelectedColor] = useState<string>('');
  const [selectedImage, setSelectedImage] = useState<string>('/shirt1.jpg');
        ...
        <div className="grid items-start grid-cols-1 md:grid-cols-2 gap-6">
          <div className="w-full lg:sticky top-0 flex gap-3 z-10">
            ...
            <div className="w-20 flex flex-col gap-3">
              {["/shirt1.jpg", "/shirt1.jpg", "/shirt1.jpg", "/shirt1.jpg"].map((img) => (
                <Image
                  key={img}
                  src={img}
                  alt="Thumbnail"
