...
const products = [
  { id: 1, name: 'Mobile', image: '/women3.jpg', price: '$12' },
  ...
  { id: 7, name: 'Women 1', image: '/women3.jpg', price: '$30' },
...
export default function Cartsec2() {
  ...
  const [selectedImage, setSelectedImage] = useState<string>('/women3.jpg');
        ...
        <div className="grid items-start grid-cols-1 md:grid-cols-2 gap-6">
          <div className="w-full lg:sticky top-0 flex gap-3 z-10">
            ...
            <div className="w-20 flex flex-col gap-3">
              {["/women3.jpg", "/women3.jpg", "/women3.jpg", "/women3.jpg"].map((img) => (
                <Image
                  key={img}
                  src={img}
                  alt="Thumbnail"
