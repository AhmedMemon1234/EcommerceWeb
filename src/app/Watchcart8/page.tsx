...
const products = [
  { id: 1, name: 'Mobile', image: '/watchpic11.jpg', price: '$12' },
  ...
  { id: 12, name: 'Watch 3', image: '/watchpic11.jpg', price: '$50' },
];

export default function Cartsec2() {
  const [selectedSize, setSelectedSize] = useState<string>('');
  const [selectedColor, setSelectedColor] = useState<string>('');
  const [selectedImage, setSelectedImage] = useState<string>('/watchpic11.jpg');
        ...
        <div className="grid items-start grid-cols-1 md:grid-cols-2 gap-6">
          <div className="w-full lg:sticky top-0 flex gap-3 z-10">
            ...
            <div className="w-20 flex flex-col gap-3">
              {["/watchpic11.jpg", "/watchpic11.jpg", "/watchpic11.jpg", "/watchpic11.jpg"].map((img) => (
                <Image
                  key={img}
                  src={img}
                  alt="Thumbnail"
