...
const products = [
  { id: 1, name: 'Toy 1', image: '/toy1.jpg', price: '$12' },
  { id: 2, name: 'Toy 2', image: '/toy2.jpg', price: '$15' },
  { id: 3, name: 'Toys', image: '/toys.jpg', price: '$20' },
  { id: 4, name: 'Watch 2', image: '/watch2.jpg', price: '$18' },
  ...
  { id: 10, name: 'Shirt 1', image: '/shirt4.jpg', price: '$40' },
  { id: 11, name: 'Shirt 2', image: '/shirt4.jpg', price: '$42' },
  { id: 12, name: 'Shirt 3', image: '/shirt4.jpg', price: '$50' },
];

export default function Cartsec2() {
  const [selectedSize, setSelectedSize] = useState<string>('');
  const [selectedColor, setSelectedColor] = useState<string>('');
  const [selectedImage, setSelectedImage] = useState<string>('/shirt4.jpg');
        ...
        <div className="grid items-start grid-cols-1 md:grid-cols-2 gap-6">
          <div className="w-full lg:sticky top-0 flex gap-3 z-10">
            ...
            <div className="w-20 flex flex-col gap-3">
              {["/shirt4.jpg", "/shirt4.jpg", "/shirt4.jpg", "/shirt4.jpg"].map((img) => (
                <Image
                  key={img}
                  src={img}
                  alt="Thumbnail"
          ...
          <div className="lg:pl-8">
            <h2 className="text-2xl font-bold text-gray-800">Adjective Attire | Kurti</h2>
            <h3 className="text-4xl font-bold text-gray-800 mt-8">$12</h3>
            ...
            <div className="mt-10 flex gap-4">
              <button
                type="button"
                onClick={() => handleAddToCart({ id: 1, name: "Adjective Attire | T-shirt", price: "$12", image: selectedImage })}
