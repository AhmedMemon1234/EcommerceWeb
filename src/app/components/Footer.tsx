...
<footer className="bg-gradient-to-r bg-black text-white">
  <div className="mt-10 max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
      <div className="text-xl font-bold mr-5 h-6 sm:h-9">
        <span className="text-red-600">AF </span>Ahmed Fashion
        </div>
        <p className="max-w-xs mt-4 text-sm text-gray-600">
            Our Ecommerce Website Design To Provide You <br /> The Best And HQ Products
        </p>
